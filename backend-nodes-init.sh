...
docker run --restart always -d --name master \
	--hostname master \
	--memory 8G --net=hdfs-net \
	--log-driver=json-file --log-opt max-size=50m --log-opt max-file=10 \
	-v /data/hbase/core-site.xml:/home/lilrose/repos/opentsdb-cluster-connection/hbase-conf-files/core-site.xml \
	-v /data/hbase/hbase-site.xml:/home/lilrose/repos/opentsdb-cluster-connection/hbase-conf-files/hbase-site.xml \
	olegfedoseev/hbase:1.2.2 master start

docker run --restart always -d --name regionserver \
	--hostname regionserver \
...
# docker run --restart always -d --name hbase-regionserver2 \
# 	--hostname hbase-regionserver2 \
# 	--memory 16G -p 16021:16020 -p 16031:16030 \
# 	--network hdfs-net \
# 	--log-driver=json-file --log-opt max-size=50m --log-opt max-file=10 \
# 	-v /data/hbase/core-site.xml:/home/lilrose/repos/opentsdb-cluster-connection/hbase-conf-files/core-site.xml \
# 	-v /data/hbase/hbase-site.xml:/home/lilrose/repos/opentsdb-cluster-connection/hbase-conf-files/hbase-site.xml \
